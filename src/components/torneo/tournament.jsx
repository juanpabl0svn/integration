    ...
    if (last === false) {
      ...
      matches.map((match) => {
        if (matchId === match.id && nameWinner === match.participants[0].name) {
          ...
          matchId === match.id &&
          nameWinner === match.participants[1].name
        ) {
          match.state = "DONE";
          match.participants[1].resultText = "Won";
          match.participants[1].isWinner = true;
                ...
                {matches.map((match) => (
                  <li key={match.id}>
                    ...
                    <button
                      ...
                      onClick={() => winner(match.id, teamA.name, true)}
                    >
                      <span>Ganador: {teamA.name}</span>
                    </button>
                    <button
                      className="winner-button"
                      onClick={() => winner(match.id, teamB.name, true)}
                    >
              ...
              <ul>
                {matches.map((match) => (
                  <li key={match.id}>
                    ...
                    {match.participants[1].name} <br></br>
                    <button
                      className="winner-button"
                      onClick={() =>
                        winner(match.id, match.participants[0].name)
                      }
                    >
                      <span>Ganador: {match.participants[0].name}</span>
                    </button>
                    <button
                      className="winner-button"
                      onClick={() =>
                        winner(match.id, match.participants[1].name)
                      }
                    >
                      <span>Ganador: {match.participants[1].name}</span>
                    </button>
                  </li>
                ))}
              </ul>
            ...
            <div>
              ...
              <ul>
                <li key={finalMatch.id}>
                  {finalMatch.participants[0].name} vs.{" "}
                  {finalMatch.participants[1].name} <br></br>
                  <button
                    className="winner-button"
                    onClick={() =>
                      winner(
                        finalMatch.id,
                        finalMatch.participants[0].name,
                        true
                      )
                    }
                  >
                    <span>Ganador: {finalMatch.participants[0].name}</span>
                  </button>
                  <button
                    className="winner-button"
                    onClick={() =>
                      winner(
                        finalMatch.id,
                        finalMatch.participants[1].name,
                        true
                      )
                    }
                  >
                    <span>Ganador: {finalMatch.participants[1].name}</span>
                  </button>
                </li>
              </ul>
            </div>
              ...
              <ul>
                {secondFight.map((match) => (
                  <li key={match.id}>
                    ...
                    >
                      Ganador: {match.participants[0].name}
                    </button>
                    <button
                      className="winner-button"
                      onClick={() =>
                    ...
                    >
                      Ganador: {match.participants[1].name}
                    </button>
                  </li>
                ))}
              </ul>
                ...
                {thirdFight.map((match) => (
                  <li key={match.id}>
                    ...
                    <button
                      className="winner-button"
                      onClick={() =>
                        winner(match.id, match.participants[0].name, true)
                      }
                    >
                      Ganador: {match.participants[0].name}
                    </button>
                    <button
                      className="winner-button"
                      onClick={() =>
                        winner(match.id, match.participants[1].name, true)
                      }
                    >
                      Ganador: {match.participants[1].name}
                    </button>
  ...
  return (
    ...
    >
      ...
      {randomizeButtonVisible && (
        ...
        >
          <span>Generar enfrentamientos</span>
        </button>
      )}
      {matches.length > 0 && generadorEnfrentamientos()}
    </div>
  );
};
